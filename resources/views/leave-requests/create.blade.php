        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Create new leave request.</p>
                </div>
                    ...
                    <form action="{{ route('leave-requests.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="leave_type" id="leave_type"
                                ...
                                <option value="annual" {{ old('leave_type') == 'annual' ? 'selected' : '' }}>Annual
                                </option>
                                <option value="sick" {{ old('leave_type') == 'sick' ? 'selected' : '' }}>
                                    Sick</option>
                                <option value="unpaid" {{ old('leave_type') == 'unpaid' ? 'selected' : '' }}>Unpaid
                                </option>
                                <option value="emergency" {{ old('leave_type') == 'emergency' ? 'selected' : '' }}>Emergency
                                </option>
                            </select>
                            @error('leave_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" value="{{ old('start_date') }}" name="start_date" id="start_date"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="end_date" value="{{ old('end_date') }}" name="end_date" id="end_date"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="" {{ old('status') == 'approved' ? 'selected' : 'approved' }}>
                                    Approved</option>
